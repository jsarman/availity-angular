  ...
  describe('form config service', function () {
    ...
    /*describe('build element container', function() {
      it('doesnt fail if no elements exist', inject(function(avFormConfigService) {
        ...
        expect(avFormConfigService._buildElementContainer(
          containerConfig)[0].outerHTML.toLowerCase().indexOf('<div><div data-inject="true"></div></div>')).not.toBe(-1);
      }));
      it('appends child containers', inject(function(avFormConfigService) {
        ...
        expect(avFormConfigService._buildElementContainer(
          containerConfig, {elements: {}})[0].outerHTML.toLowerCase().indexOf('<div data-inject="true"><span data-inject="true"></span></div>')).not.toBe(-1);
      }));
      it('doesnt fail if element returned is not defined', inject(function(avFormConfigService) {
        ...
        expect(avFormConfigService._buildElementContainer(
          containerConfig, {elements: {}})[0].outerHTML.toLowerCase().indexOf('<div data-inject="true"></div>')).not.toBe(-1);
      }));
      it('appends elements', inject(function(avFormConfigService) {
        ...
        expect(avFormConfigService._buildElementContainer(
          containerConfig, {elements: {}})[0].outerHTML.toLowerCase().indexOf('<div data-inject="true"><input name="memberid" type="text"></div>')).not.toBe(-1);
      }));
    });*/
