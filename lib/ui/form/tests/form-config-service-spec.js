  ...
  describe('form config service', function () {
    ...
    describe('build element container', function() {
      it('doesnt fail if no elements exist', inject(function(avFormConfigService) {
        ...
        expect(avFormConfigService._buildElementContainer(containerConfig)[0].outerHTML).toBe('<div><div data-inject="true"></div></div>');
      }));
      it('appends child containers', inject(function(avFormConfigService) {
        ...
        expect(avFormConfigService._buildElementContainer(containerConfig, {elements: {}})[0].outerHTML).toBe('<div data-inject="true"><span data-inject="true"></span></div>');
      }));
      it('doesnt fail if element returned is not defined', inject(function(avFormConfigService) {
        ...
        expect(avFormConfigService._buildElementContainer(containerConfig, {elements: {}})[0].outerHTML).toBe('<div data-inject="true"></div>');
      }));
      it('appends elements', inject(function(avFormConfigService) {
        ...
        expect(avFormConfigService._buildElementContainer(containerConfig, {elements: {}})[0].outerHTML).toBe('<div data-inject="true"><input name="memberId" type="text"></div>');
      }));
    });
