/* global describe, it, jasmine, angular, expect, beforeEach, angular, inject */
describe('placeholder', function() {

  'use strict';

  var availity = require('../placeholder');
  ...
  beforeEach(function() {
    ...
    angular.mock.module('availity', function (avValProvider) {
