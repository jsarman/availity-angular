/*global inject, describe, it, beforeEach, expect, angular, spyOn*/
describe('avPollingService', function() {

  'use strict';

  var availity = require('../polling');
  ...
  it('should return relative url from API aysnc response href attribute', function() {
    ...
    var url = avPollingService.getUrl('https://qua.api.availity.com/v1/dummy');
