/*global it, spyOn, angular, inject, beforeEach, expect, describe */
describe('avExceptionAnalyticsProvider', function() {

  'use strict';

  var availity = require('../analytics-exceptions');
  ...
  beforeEach(angular.mock.module(function(avExceptionAnalyticsProvider, $exceptionHandlerProvider) {
