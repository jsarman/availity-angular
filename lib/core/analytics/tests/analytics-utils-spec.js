/*global inject, beforeEach, expect, angular, describe, it */
describe('avAnalyticsUtils', function() {
  'use strict';

  var availity = require('../analytics-util');
  ...
  it('getAttribute() should return a object', function() {
    var obj = avAnalyticsUtils.getAttribute('avAnalyticsLabel', 'yumm');
  ...
  it('getProperties() should return a object with only analytic properties', function() {
    ...
    var obj = avAnalyticsUtils.getProperties(attrs);
