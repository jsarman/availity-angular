/*global describe, inject, beforeEach, afterEach, it, expect, jasmine, angular*/
...
describe('AvApiResource', function() {
  ...
  describe('rest', function() {
    ...
    describe('update()', function () {
      ...
      it('should update a single entity without explicit id', function () {

        $httpBackend.expectPUT('/api/v1/users').respond(200, updateResponseData);

        users.update({ id: 1 }).success(function (data) {
          expect(data).toBeEqual(updateResponseData);
          callback();
        });
