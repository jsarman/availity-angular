/**
 * availity-angular v0.6.4 -- April-09
...
// Source: /lib/ui/typeahead/typeahead.js
(function(root) {
        ...
        // scope.searchProviders().then(function(_providers) {
          ...
          var options = new Bloodhound({
            datumTokenizer: function(provider) {
              return Bloodhound.tokenizers.whitespace(provider.taxid + ' ' + provider.firstName + ' ' +provider.lastName);
            },
          ...
          var dataSets = {
            ...
            templates: {
              suggestion: Handlebars.compile(scope.template)
            }
          };
